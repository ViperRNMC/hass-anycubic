...
class AnycubicMQTTAPI(AnycubicAPIFunctions):
    __slots__ = (
        ...
        "_mqtt_callback_disconnected",
        "_mqtt_callback_connect_failed",
    )
    ...
    def __init__(
        ...
        *args: Any,
        ...
        mqtt_callback_disconnected: Callable[[int], None] | None = None,
        mqtt_callback_connect_failed: Callable[[int], None] | None = None,
        **kwargs: Any,
    ) -> None:
        ...
        self._mqtt_callback_disconnected: Callable[[int], None] | None = mqtt_callback_disconnected
        self._mqtt_callback_connect_failed: Callable[[int], None] | None = mqtt_callback_connect_failed
    ...
    def _mqtt_publish_on_topic(
        ...
        if self._mqtt_log_all_messages:
            self._log_to_debug(
                f"Anycubic MQTT Publish on topic: {topic}\n"
                f"    {mqtt_payload}"
            )
    ...
    def _mqtt_on_disconnect(
        ...
        if rc == 0:
            ...
            if self._mqtt_callback_disconnected:
                self._mqtt_callback_disconnected(rc)
    ...
    def _mqtt_on_connect(
        ...
        if rc == 0:
            ...
            if self._mqtt_callback_connect_failed:
                self._mqtt_callback_connect_failed(rc)
